...
export default function TabContextMenu({ showContextMenu, contextMenuPosition, handlePinTab }: TabContextMenuProps) {
  // Якщо контекстне меню не має бути показане, повертаємо null
